...
issue_1=proj_1.issues.create! :title => "as a user, i want a fly"
issue_2=proj_1.issues.create! :title => "as a user, i want my fly"
issue_3=proj_1.issues.create! :title => "as a user, i want to fly"
issue_4=proj_2.issues.create! :title => "as a user, i will add project"
issue_5=proj_2.issues.create! :title => "as a developer, i want to kill myself"
issue_6=proj_3.issues.create! :title => "as a user, i want to be human"
issue_7=proj_4.issues.create! :title => "as a user, i want to fuck myself"